    ...
    SensorValueIntf::Unit unit, bool asserted) -> sdbusplus::async::task<>
{
    ...
    info("Sensor reading event for {EVENT_NAME} is {STATUS}", "EVENT_NAME",
    ...
    -> sdbusplus::async::task<>
{
    ...
    info("Sensor failure event for {EVENT_NAME} is {STATUS}", "EVENT_NAME",
         eventName, "STATUS", (asserted ? "asserted" : "deasserted"));
}
    ...
    bool asserted) -> sdbusplus::async::task<>
{
    ...
    info("Controller failure event for {EVENT_NAME} is {STATUS}", "EVENT_NAME",
         eventName, "STATUS", (asserted ? "asserted" : "deasserted"));
}
    ...
    -> sdbusplus::async::task<>
{
    ...
    info("Power fault event for {EVENT_NAME} is {STATUS}", "EVENT_NAME",
         eventName, "STATUS", (asserted ? "asserted" : "deasserted"));
}
    ...
    -> sdbusplus::async::task<>
{
    ...
    info("Filter failure event for {EVENT_NAME} is {STATUS}", "EVENT_NAME",
         eventName, "STATUS", (asserted ? "asserted" : "deasserted"));
}
    ...
    -> sdbusplus::async::task<>
{
    ...
    info("Pump failure event for {EVENT_NAME} is {STATUS}", "EVENT_NAME",
         eventName, "STATUS", (asserted ? "asserted" : "deasserted"));
}
                                     ...
                                     bool asserted) -> sdbusplus::async::task<>
{
    ...
    info("Fan failure event for {EVENT_NAME} is {STATUS}", "EVENT_NAME",
         eventName, "STATUS", (asserted ? "asserted" : "deasserted"));
}
