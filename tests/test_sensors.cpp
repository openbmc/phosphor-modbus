...
// Sensor value decoding/formatting and register-span behavior.
class SensorsTest : public SensorTestBase
{
  public:
    SensorsTest() :
        SensorTestBase("/tmp/ttySensorsTestPort0", "/tmp/ttySensorsTestPort1",
