...
class SensorsTest : public ::testing::Test
{
  public:
    ...
    static constexpr const auto deviceName = "ResorviorPumpUnit";
...
{
    auto fullSensorName =
        std::format("{}_{}_{}_{}", deviceName, TestIntf::testDeviceAddress,
                    portConfig.name, sensorName);

    auto objectPath = std::format(
...
TEST_F(SensorsTest, TestSensorValueSigned)
{
    ...
    auto objectPath = std::format(
        "{}/{}/{}", SensorValueIntf::namespace_path::value,
        SensorValueIntf::namespace_path::temperature, fullSersorName);
    ...
    constexpr int16_t expectedSigned =
        static_cast<int16_t>(TestIntf::testReadHoldingRegisterTempSigned);
...
TEST_F(SensorsTest, TestSensorValueWithSettings)
{
    ...
    ctx.spawn(testSensorCreation(
        ...
        applyValueSettings(TestIntf::testReadHoldingRegisterTempUnsigned,
